...
public class RegistrarMiembro extends javax.swing.JFrame {
     ...
     */
    public RegistrarMiembro(StmtSQL cxn, Miembros vMiembros) {
    ...
    private void initComponents() {
        ...
        line_domicilio = new javax.swing.JSeparator();
        ...
        lbl_titleRegistroLibro.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_add_user_male_25px.png"))); // NOI18N
        lbl_titleRegistroLibro.setText("Registro Usuario");
        ...
        main_panelRegistroLibro.add(lbl_titleRegistroLibro, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 180, 30));
        ...
        txtf_email.setCaretColor(new java.awt.Color(255, 255, 255));
        txtf_email.setOpaque(false);
        ...
        txtf_numTelefono.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtf_numTelefonoActionPerformed(evt);
            }
        });
                ...
                .addGroup(panel_formularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel_formularioLayout.createSequentialGroup()
                        .addGroup(panel_formularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_formularioLayout.createSequentialGroup()
                                .addComponent(txtf_nombre, javax.swing.GroupLayout.PREFERRED_SIZE, 253, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(panel_formularioLayout.createSequentialGroup()
                        .addGroup(panel_formularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(line_email, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                    ...
                    .addGroup(panel_formularioLayout.createSequentialGroup()
                        .addGroup(panel_formularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(line_domicilio, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtf_domicilio, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 228, Short.MAX_VALUE))
                        .addGap(32, 32, 32)
                        .addGroup(panel_formularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(line_numTelefono, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtf_numTelefono, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addComponent(line_nombreUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 253, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
        panel_formularioLayout.setVerticalGroup(
            ...
            .addGroup(panel_formularioLayout.createSequentialGroup()
                ...
                .addGroup(panel_formularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtf_numTelefono)
                    .addGroup(panel_formularioLayout.createSequentialGroup()
                        .addComponent(txtf_domicilio)
                        .addGap(1, 1, 1)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_formularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(line_domicilio, javax.swing.GroupLayout.PREFERRED_SIZE, 10, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtf_emailKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtf_emailKeyTyped
        if(txtf_email.getText().length() >= 50)
            evt.consume();
    ...
    private void limpiar(){
        ...
        txtf_numTelefono.setText("");
        txtf_email.setText("");
    }
    
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        nMiembro[2] = txtf_nombre.getText().toLowerCase().replaceAll("^\\s*","").replaceAll("\\s*$","");
        nMiembro[1] = generarClave(nMiembro[2]);
        Calendar f = dc_fechaNacimiento.getCalendar();
        nMiembro[3] = f.get(Calendar.YEAR)+"-"+(f.get(Calendar.MONTH)+1)+"-"+f.get(Calendar.DATE);
        nMiembro[4] = txtf_domicilio.getText().toLowerCase().replaceAll("^\\s*","").replaceAll("\\s*$","");
        nMiembro[5] = txtf_numTelefono.getText().toLowerCase().replaceAll("^\\s*","").replaceAll("\\s*$","");
        nMiembro[6] = txtf_email.getText().toLowerCase().replaceAll("^\\s*","").replaceAll("\\s*$","");
        ...
        nMiembro[7] = fecha;
        try {
            cxn.registrarMiembro(nMiembro);
            JOptionPane.showMessageDialog(null, "Se ha registrado un nuevo Miembro.", "Codex",1);
    ...
    private void txtf_numTelefonoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtf_numTelefonoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtf_numTelefonoActionPerformed

    private void txtf_domicilioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtf_domicilioKeyTyped
        if(txtf_domicilio.getText().length() >= 100)
            evt.consume();
    }//GEN-LAST:event_txtf_domicilioKeyTyped

    private String generarClave(String cadena) {
        String folio = ""; 
        String[] splitCad = cadena.replaceAll("\\s", "").split("");
        folio += splitCad[splitCad.length/2-1];
        int numAleatorio;
        for(int i=0; i<4; ++i){
            numAleatorio = (int)(Math.random()*10);
            folio = numAleatorio+folio; 
        }       
        return folio;
    }
    /**
    ...
    private javax.swing.JSeparator line_domicilio;
